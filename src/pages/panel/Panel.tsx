    ...
    <div className="nb-bg nb-text min-h-screen p-6 nb-bg-grid">
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="nb-card nb-bg-halftone p-6 md:p-8 relative overflow-hidden">
          <div className="absolute -top-6 -left-6 w-16 h-16 bg-[color:var(--nb-accent-green)] border-2 border-[color:var(--nb-border)] opacity-20 nb-float" aria-hidden="true" />
          <div className="absolute -bottom-8 -right-8 w-20 h-20 bg-[color:var(--nb-accent-pink)] border-2 border-[color:var(--nb-border)] opacity-20 nb-sticker-1" aria-hidden="true" />
