    ...
    <div className="nb-bg nb-text min-h-screen p-6 nb-bg-grid">
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="nb-card nb-bg-halftone p-6 md:p-8 relative overflow-hidden">
          <div className="absolute -top-6 -right-6 w-16 h-16 rounded-full bg-[color:var(--nb-deco-sand)] border-2 border-[color:var(--nb-border)] opacity-60 nb-rotate-slow" aria-hidden="true" />
          <div className="absolute -bottom-8 -left-8 w-20 h-20 bg-[color:var(--nb-deco-sky)] border-2 border-[color:var(--nb-border)] opacity-60 nb-sticker-2" style={{ borderRadius: '30% 70% 70% 30% / 30% 30% 70% 70%' }} aria-hidden="true" />
          ...
          <div className="flex flex-wrap items-center gap-3">
            <span className="nb-badge nb-badge-yellow nb-sticker-1">{t('options.title')}</span>
        ...
        <section className="nb-card-static p-6 md:p-8 nb-bg-halftone relative overflow-hidden">
          <div className="absolute top-4 right-4 w-4 h-4 bg-[color:var(--nb-deco-rose)] border-2 border-[color:var(--nb-border)] nb-sticker-3" aria-hidden="true" />
