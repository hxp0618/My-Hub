  ...
  return (
    <div className="nb-bg nb-text min-h-screen p-4 nb-bg-grid">
      <div className="nb-card p-4 relative overflow-hidden nb-bg-halftone">
        <div className="absolute -top-4 -right-4 w-14 h-14 bg-[color:var(--nb-deco-sand)] border-2 border-[color:var(--nb-border)] opacity-60 nb-rotate-slow" aria-hidden="true" />
        <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-[color:var(--nb-deco-sky)] border-2 border-[color:var(--nb-border)] opacity-60 nb-sticker-2" style={{ borderRadius: '30% 70% 70% 30% / 30% 30% 70% 70%' }} aria-hidden="true" />
