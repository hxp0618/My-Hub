  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        <div className="w-full nb-bg-card border-2 border-[color:var(--nb-border)] h-6 overflow-hidden shadow-[var(--nb-shadow-sm)]">
          <div
        ...
        {showPercentage && (
          <div className="absolute right-0 top-full mt-2">
            <span className="inline-block px-2 py-1 bg-[color:var(--nb-card)] border-2 border-[color:var(--nb-border)] shadow-[var(--nb-shadow-sm)] text-xs font-bold nb-text">
...
export const CircularProgress: React.FC<CircularProgressProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <div
        className="relative border-4 border-[color:var(--nb-border)] shadow-[var(--nb-shadow-lg)] bg-[color:var(--nb-card)]"
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="px-3 py-1 bg-[color:var(--nb-accent-yellow)] border-2 border-[color:var(--nb-border)] shadow-[var(--nb-shadow-sm)]">
            <span className="text-lg font-black text-[color:var(--nb-text-on-accent)] uppercase">
              {Math.round(clampedProgress)}%
            </span>
          </div>
        </div>
