        ...
        <div className="flex gap-2 border-b-[length:var(--nb-border-width)] border-[color:var(--nb-border)] pb-2">
          <button
            ...
            className={`px-4 py-2 text-sm font-bold uppercase tracking-wide transition-all duration-150 ${
              activeTab === 'enable'
                ? 'bg-[color:var(--nb-accent-yellow)] text-[color:var(--nb-text-on-accent)] border-2 border-[color:var(--nb-border)] shadow-[var(--nb-shadow)]'
            ...
            <div className="space-y-2 max-h-80 overflow-y-auto">
              {orderedTools.map(tool => {
                ...
                return (
                  <div
                    key={tool.id}
                    className="nb-card-static flex items-center justify-between p-3 hover:shadow-[var(--nb-shadow-sm)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-150"
                  >
